...
<div class="appointment-page">
    ...
    <form method="POST" action="/appointment.php" id="appointmentForm">
        ...
        <div class="step-card" id="step1">
            <h2><span class="step-number">1</span> Выберите услуги</h2>
        ...
        <div class="step-card" id="step2">
            <h2><span class="step-number">2</span> Выберите автомобиль</h2>
        ...
        <div class="step-card" id="step3">
            <h2><span class="step-number">3</span> Выберите дату и время</h2>
        ...
        <!-- ====== ШАГ 4: ПРИМЕЧАНИЯ ====== -->
        <div class="step-card">
            <h2><span class="step-number">4</span> Примечания</h2>
